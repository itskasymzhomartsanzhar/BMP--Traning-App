...
export const RECIPES = [
  ...
  {
    id: 'r3',
    title: 'Греческий йогурт + ягоды',
    calories: '260 ккал',
    macros: 'Б 25 · Ж 6 · У 27',
    time: '5 мин',
    ingredients: ['200 г гreek yogurt', '80 г ягод', '15 г мёда', '20 г гранолы'],
...
export const MEAL_DETAILS = {
  breakfast: { title: 'Завтрак', items: ['Омлет 3 яйца', 'Хлеб цельнозерновой 40 г', 'Кофе без сахара'], kcal: 480 },
  lunch: { title: 'Обед', items: ['Куриная грудка 150 г', 'Рис 80 г', 'Овощной салат'], kcal: 620 },
  snack: { title: 'Перекус', items: ['Протеиновый батончик', 'Яблоко'], kcal: 210 },
  dinner: { title: 'Ужин', items: ['Лосось 120 г', 'Киноа 60 г', 'Брокколи'], kcal: 540 },
}
