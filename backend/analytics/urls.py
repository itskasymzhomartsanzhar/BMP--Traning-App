...
from .views import ActivityView, CalendarView, StreakView, WeightHistoryView, MeasurementsView, ProgressPhotosView

urlpatterns = [
    path('analytics/activity/', ActivityView.as_view()),
    path('analytics/streak/', StreakView.as_view()),
    path('analytics/calendar/', CalendarView.as_view()),
