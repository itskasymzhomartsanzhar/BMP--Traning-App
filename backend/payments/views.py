...
class MySubscriptionView(APIView):
    ...
    def get(self, request):
        ...
        return Response({
            ...
            # Только то, что реально есть в приложении.
            'features': [
                'Программы тренировок для зала и дома',
                'План тренировок по вашей анкете',
                'Дневник питания: КБЖУ и вода',
                'Аналитика: вес, замеры, фото прогресса',
